---
title: "Filter cleaning vs filter replacement: when to do which"
slug: filter-cleaning-vs-replacement
description: "Cleaning resets the curve. Replacement resets the equipment. Here is how to tell the difference, with concrete signs that your filter media is at end of life rather than just dirty."
pillar: cost
target_keyword: filter cleaning vs replacement
search_volume: 30
...
faqs:
  - q: How long do pool filter cartridges last?
    a: Three to five years with regular cleaning. Some cartridges last longer if usage is light. Most fail because the pleats deform under pressure cycles or the end-cap bands degrade from UV exposure, not because the material wears out from filtration itself.
  - q: How can I tell if my filter cartridge needs to be replaced instead of cleaned?
    a: Three reliable signs. First, the pleats no longer hold their shape after a soak. Second, the end-cap bands are split, missing, or pulling away. Third, the gauge does not return to the original clean PSI even after a thorough cleaning. Any two of those mean replacement.
  - q: Is it cheaper to clean or replace pool filters?
    a: Cleaning is cheaper per visit at $75 versus replacement at $200 to $1,000 for a cartridge set, $200 to $500 for a DE grid set, or $150 to $300 for a sand media swap. But cleaning a worn-out filter is wasted money. Once the media is at end of life, replacement is the right answer.
  - q: How often should you replace pool filter cartridges?
    a: Every three to five years for cartridges. Every four to six years for DE grid sets. Every five to seven years for sand. These are rough averages, and a careful inspection at each cleaning lets you replace exactly when needed rather than on a calendar.
---
...
If you live in [San Diego](/san-diego), [Carlsbad](/carlsbad), or [Poway](/poway) and you are not sure whether to clean or replace, [book a $75 cleaning](/book). The visit includes a full inspection. We will tell you honestly whether the media is at end of life and order parts at our cost if you want us to.

For the full breakdown of what each service visit includes, and how we keep parts at cost rather than marking them up, see our [service guide](/pool-filter-cleaning) and [pricing page](/pricing).
