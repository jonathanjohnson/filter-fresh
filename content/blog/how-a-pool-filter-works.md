---
title: "How a pool filter actually works: cartridge, DE, and sand explained"
slug: how-a-pool-filter-works
description: "A pool filter is the lungs of your pool. Here is what is happening inside the three types you might own (cartridge, DE, sand), in plain English, with no jargon."
pillar: education
target_keyword: how a pool filter works
search_volume: 20
...
faqs:
  - q: How does a pool cartridge filter work?
    a: Water enters the tank, passes radially through pleated polyester elements that trap particles down to 15 to 20 microns, and exits back to the pool. The pleats catch debris in their geometry. Periodic cleaning removes the trapped material before the pleats clog completely.
  - q: How does a DE pool filter work?
    a: Water enters the tank where diatomaceous earth coats fabric grids. The microscopic skeletons of fossilized diatoms create a filter cake that catches particles down to 3 microns. DE is the finest residential filtration available. Grids have to be pulled, cleaned, and recharged with fresh DE periodically.
  - q: How does a sand filter work?
    a: Water flows down through a bed of #20 silica sand. The sharp edges of the grains trap particles at 25 to 40 microns. When the bed loads up, you reverse the flow to flush trapped debris out the waste line, which is called backwashing. The bed itself wears down over 5 to 7 years and needs replacement.
  - q: Which type of pool filter is best?
    a: For finest filtration, DE. For lowest maintenance, sand with a media swap every five to seven years. For the best balance of filtration, ease of service, and cost, cartridge. Most new pools in Southern California are built with cartridge systems for that reason.
---
...
1. Your pump pushes water through the inlet at the bottom of the tank.
2. Water rises around the elements and flows radially through the pleats.
3. Particles down to 15 to 20 microns get caught in the pleat geometry.
4. Filtered water exits through the top manifold and returns to the pool.
...
Service is straightforward. Pump off, lid open, pull each cartridge straight up, soak in a commercial degreaser, hand rinse pleat by pleat, inspect, reassemble. We walk through the full process in our [pool filter cleaning service guide](/pool-filter-cleaning).
...
1. You add fresh DE through the skimmer at startup.
2. The pump pulls the powder into the filter tank.
3. DE settles on the grid fabric, forming a thin, porous filter cake.
4. Water passes through the cake, which traps particles down to 3 microns.
5. Filtered water exits through the top manifold.
...
1. Water enters from the top, distributed across the surface of the sand bed.
2. Particles get trapped at 25 to 40 microns as water passes between grains.
3. Filtered water exits through fingered laterals at the bottom of the tank.
4. The multiport valve directs filtered water back to the return.
...
This is the reason sand filters are popular at apartment complexes, hotels, and commercial pools. The weekly maintenance is short. The expensive part is the periodic media replacement every five to seven years, which we cover in our [service guide](/pool-filter-cleaning).
...
All three keep pool water swimmable. DE produces visibly clearer water. Sand requires the least weekly attention but the most periodic intervention. Cartridge sits in between on both axes, which is why it dominates new installations across [Temecula](/temecula), [Murrieta](/murrieta), and [San Diego](/san-diego).
...
The full local cadence breakdown is in our [Southern California cleaning frequency post](/blog/how-often-to-clean-pool-filter-southern-california).
...
If you live in [Temecula](/temecula) or [Murrieta](/murrieta) and you are not sure what is happening on your equipment pad, [book a $75 cleaning](/book) and we will identify the filter type, document the system, and tell you exactly what is going on.
...
If you want a one-time inspection to confirm what you have and start a maintenance baseline, [book a $75 cleaning](/book). We will identify the filter, document the equipment, and leave the clean PSI on the housing for next time.
